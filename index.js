...
client.on('interactionCreate', async (interaction) => {
  if (interaction.isButton()) {
    if(!interaction.member.roles.cache.has('1169720423127199744')) return interaction.reply('لا يمكنك نسخ السيرفر يجب عليك الحصول علي رتبة مشترك ارسل دليل اشتراكك في القناة هنا <#1169720494744932513>');
